...
var _translationsEnJson = require("./translationsEn.json");
var _translationsEnJsonDefault = parcelHelpers.interopDefault(_translationsEnJson);
var _translationsRuJson = require("./translationsRu.json");
var _translationsRuJsonDefault = parcelHelpers.interopDefault(_translationsRuJson);
const initMainApp = ()=>{
    const node = document.getElementById("root");
    const ELM_APP_BASE_API_URL = {
    };
    const flags = {
...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Main$Ready = F2(function(a, b) {
        return {
            $: 'Ready',
            a: a,
            b: b
    ...
    var $author$project$Translations$AllTranslations = F2(function(en, ru) {
        return {
            en: en,
            ru: ru
        };
    ...
    var $author$project$Translations$Model = function(a) {
        return {
            $: 'Model',
            a: a
        };
    ...
    var $ChristophP$elm_i18next$I18Next$flattenTranslationsHelp = F3(function(initialValue, namespace, dict) {
        return A3($elm$core$Dict$foldl, F3(function(key, val, acc) {
            var newNamespace = function(currentKey) {
                return $elm$core$String$isEmpty(namespace) ? currentKey : namespace + ('.' + currentKey);
            };
            if (val.$ === 'Leaf') {
                var str = val.a;
                return A3($elm$core$Dict$insert, newNamespace(key), str, acc);
            } else {
                var children = val.a;
                return A3($ChristophP$elm_i18next$I18Next$flattenTranslationsHelp, acc, newNamespace(key), children);
            }
        }), initialValue, dict);
    });
    ...
    function $ChristophP$elm_i18next$I18Next$cyclic$treeDecoder() {
        return $elm$json$Json$Decode$oneOf(_List_fromArray([
            ...
            $elm$json$Json$Decode$lazy(function(_v0) {
                return A2($elm$json$Json$Decode$map, $ChristophP$elm_i18next$I18Next$Branch, $elm$json$Json$Decode$dict($ChristophP$elm_i18next$I18Next$cyclic$treeDecoder()));
            })
        ]));
    }
    try {
    ...
    var $author$project$Translations$decode = A2($elm$json$Json$Decode$map, function(allTranslations) {
        return $author$project$Translations$Model({
            allTranslations: allTranslations,
            selectedLanguage: $author$project$Translations$En
        });
    }, A3($NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required, 'ru', $ChristophP$elm_i18next$I18Next$translationsDecoder, A3($NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required, 'en', $ChristophP$elm_i18next$I18Next$translationsDecoder, $elm$json$Json$Decode$succeed($author$project$Translations$AllTranslations))));
    var $author$project$ToDoItems$ToDoItem = F3(function(id, title, completed) {
        return {
            completed: completed,
            id: id,
            title: title
    ...
    var $author$project$ToDoItems$decodeToDoItem = A3($NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required, 'completed', $elm$json$Json$Decode$bool, A3($NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required, 'title', $elm$json$Json$Decode$string, A3($NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required, 'id', $elm$json$Json$Decode$int, $elm$json$Json$Decode$succeed($author$project$ToDoItems$ToDoItem))));
    var $author$project$ToDoItems$decodeToDoItems = $elm$json$Json$Decode$list($author$project$ToDoItems$decodeToDoItem);
    var $author$project$ToDoItems$initialToDoItems = _List_Nil;
    ...
    var $author$project$Api$init = function(_v0) {
        var baseApiUrl = _v0.baseApiUrl;
        var accessToken = _v0.accessToken;
        var initialPayload = {
            accessToken: accessToken,
            baseApiUrl: baseApiUrl
        };
        return $author$project$Api$Api(initialPayload);
    };
    var $author$project$Taco$Taco = function(a) {
        return {
            $: 'Taco',
            a: a
        };
    ...
    var $author$project$Router$NextPageRoute = {
        $: 'NextPageRoute'
    };
    var $author$project$Router$ToDoItemRoute = {
        $: 'ToDoItemRoute'
    };
    ...
    var $author$project$Router$parser = $elm$url$Url$Parser$oneOf(_List_fromArray([
        A2($elm$url$Url$Parser$map, $author$project$Router$ToDoItemRoute, $elm$url$Url$Parser$top),
        A2($elm$url$Url$Parser$map, $author$project$Router$ToDoItemRoute, $elm$url$Url$Parser$s('todoitempage')),
        A2($elm$url$Url$Parser$map, $author$project$Router$NextPageRoute, $elm$url$Url$Parser$s('nextpage'))
    ]));
    var $author$project$Router$parseUrl = function(url) {
        return A2($elm$url$Url$Parser$parse, $author$project$Router$parser, url);
    };
    var $author$project$Main$NextPage = function(a) {
        return {
            $: 'NextPage',
            a: a
        };
    };
    var $author$project$Main$NextPageMsg = function(a) {
        return {
            $: 'NextPageMsg',
            a: a
        };
    ...
    var $author$project$Main$ToDoItemPageMsg = function(a) {
        return {
            $: 'ToDoItemPageMsg',
            a: a
        };
    };
    var $author$project$Taco$getKey = function(_v0) {
        var key = _v0.a.key;
        return key;
    };
    ...
    var $author$project$Main$routeToPage = F2(function(_v0, route) {
        ...
        var flags = _v0.flags;
        if (route.$ === 'Just') {
            if (route.a.$ === 'ToDoItemRoute') {
                var _v2 = route.a;
                var _v3 = $author$project$Pages$ToDoItemPage$init(flags.toDoItems);
                var toDoItemPageModel = _v3.a;
                var toDoItemPageCmd = _v3.b;
                return _Utils_Tuple2($author$project$Main$ToDoItemPage(toDoItemPageModel), A2($elm$core$Platform$Cmd$map, $author$project$Main$ToDoItemPageMsg, toDoItemPageCmd));
            } else {
                var _v4 = route.a;
                var _v5 = $author$project$Pages$ToDoItemPage$init(flags.toDoItems);
                var nextPageModel = _v5.a;
    ...
    var $author$project$Translations$changeLanguage = F2(function(language, _v0) {
        ...
        return $author$project$Translations$Model(updatedModelPayload);
    });
    var $author$project$Taco$getTranslations = function(_v0) {
        var translations = _v0.a.translations;
        return translations;
    };
    ...
    var $author$project$Api$get = F4(function(decoder, msg, endpointSuffix, _v0) {
        var baseApiUrl = _v0.a.baseApiUrl;
        var accessToken = _v0.a.accessToken;
        return $elm$http$Http$request({
            body: $elm$http$Http$emptyBody,
            expect: A2($elm$http$Http$expectJson, function(response) {
                return msg($krisajenkins$remotedata$RemoteData$fromResult(response));
            }, decoder),
            headers: _List_fromArray([
                A2($elm$http$Http$header, 'x-customToken', accessToken)
            ]),
            method: 'GET',
            timeout: $elm$core$Maybe$Nothing,
            tracker: $elm$core$Maybe$Nothing,
            url: _Utils_ap(baseApiUrl, endpointSuffix)
        });
    });
    ...
    var $author$project$Pages$ToDoItemPage$update = F3(function(msg, _v0, sharedState) {
        var model = _v0.a;
        switch(msg.$){
            case 'FetchResponse':
                var response = msg.a;
            ...
            case 'ClickedCompleteToDoItem':
                var id = msg.a;
                var completed = msg.b;
                var updatedToDoItem = function(item) {
    ...
    var $author$project$Api$setAccessToken = F2(function(token, _v0) {
        ...
        return $author$project$Api$Api(updatedPayload);
    });
    var $author$project$Taco$update = F2(function(msg, _v0) {
        var sharedStatePayload = _v0.a;
        switch(msg.$){
            case 'NoUpdate':
                return $author$project$Taco$Taco(sharedStatePayload);
            case 'SetAccessToken':
                var accessToken = msg.a;
                var updatedApi = A2($author$project$Api$setAccessToken, accessToken, sharedStatePayload.api);
            ...
            case 'UpdatedApi':
                ...
                return $author$project$Taco$Taco(updatedTacoPayload);
            case 'UpdatedShowingTranslationsButton':
                var showingLanguageButtons = msg.a;
                var updatedTacoPayload = _Utils_update(sharedStatePayload, {
        ...
        _v0$11: while(true){
            if (_v0.b.$ === 'Ready') switch(_v0.a.$){
                case 'LinkClicked':
                    ...
                    var _v1 = _v0.b;
                    var sharedState = _v1.a.sharedState;
                    if (urlRequest.$ === 'Internal') {
                        var url = urlRequest.a;
                        return _Utils_Tuple2(model, A2($elm$browser$Browser$Navigation$pushUrl, $author$project$Taco$getKey(sharedState), $elm$url$Url$toString(url)));
                    } else {
                ...
                case 'UrlChanged':
                    var url = _v0.a.a;
                    var _v3 = _v0.b;
                    var readyModel = _v3.a;
                    var _v4 = A2($author$project$Main$routeToPage, readyModel, $author$project$Router$parseUrl(url));
                    var page = _v4.a;
                    return _Utils_Tuple2(A2($author$project$Main$Ready, readyModel, page), $elm$core$Platform$Cmd$none);
                case 'ToDoItemPageMsg':
                    if (_v0.b.b.$ === 'ToDoItemPage') {
                        var subMsg = _v0.a.a;
                        var _v5 = _v0.b;
                        var readyModel = _v5.a;
                        var subModel = _v5.b.a;
                        var _v6 = A3($author$project$Pages$ToDoItemPage$update, subMsg, subModel, readyModel.sharedState);
                        var updatedPageModel = _v6.a;
                        var pageCmd = _v6.b;
                        var sharedStateMsg = _v6.c;
                ...
                case 'NextPageMsg':
                    if (_v0.b.b.$ === 'NextPage') {
                        var subMsg = _v0.a.a;
                        var _v7 = _v0.b;
                        var readyModel = _v7.a;
                        var submodel = _v7.b.a;
                        var _v8 = A3($author$project$Pages$ToDoItemPage$update, subMsg, submodel, readyModel.sharedState);
                        var updatedPageModel = _v8.a;
                        var pageCmd = _v8.b;
                        var sharedStateMsg = _v8.c;
                        var updatedTaco = A2($author$project$Taco$update, sharedStateMsg, readyModel.sharedState);
                        var updatedReadyModel = _Utils_update(readyModel, {
                            sharedState: updatedTaco
                        });
    ...
    var $author$project$Router$GoogleRoute = {
        $: 'GoogleRoute'
    };
    ...
    var $rtfeldman$elm_css$Css$Structure$compactHelp = F2(function(declaration, _v0) {
        ...
        switch(declaration.$){
            case 'StyleBlockDeclaration':
                ...
                var properties1 = _v2.c;
                return $elm$core$List$isEmpty(properties1) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(keyframesByName, A2($elm$core$List$cons, declaration, declarations));
            case 'MediaRule':
            ...
            case 'PageRule':
                var properties1 = declaration.b;
                return $elm$core$List$isEmpty(properties1) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(keyframesByName, A2($elm$core$List$cons, declaration, declarations));
            case 'FontFace':
                var properties1 = declaration.a;
                return $elm$core$List$isEmpty(properties1) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(keyframesByName, A2($elm$core$List$cons, declaration, declarations));
            case 'Keyframes':
    ...
    var $rtfeldman$elm_css$Css$Structure$Output$mediaQueryToString = function(mediaQuery) {
        ...
        switch(mediaQuery.$){
            case 'AllQuery':
                var expressions1 = mediaQuery.a;
                return A2($elm$core$String$join, ' and ', A2($elm$core$List$map, $rtfeldman$elm_css$Css$Structure$Output$mediaExpressionToString, expressions1));
            case 'OnlyQuery':
                var mediaType1 = mediaQuery.a;
                var expressions1 = mediaQuery.b;
                return A3(prefixWith, 'only', mediaType1, expressions1);
            case 'NotQuery':
                var mediaType1 = mediaQuery.a;
                var expressions1 = mediaQuery.b;
                return A3(prefixWith, 'not', mediaType1, expressions1);
            default:
                var str1 = mediaQuery.a;
                return str1;
        }
    };
    ...
    var $rtfeldman$elm_css$Css$Preprocess$Resolve$applyStyles = F2(function(styles, declarations) {
        if (!styles.b) return declarations;
            ...
            case 'ExtendSelector':
                var _v4 = styles.a;
                var selector = _v4.a;
                var nestedStyles1 = _v4.b;
                var rest = styles.b;
                return A4($rtfeldman$elm_css$Css$Preprocess$Resolve$applyNestedStylesToLast, nestedStyles1, rest, $rtfeldman$elm_css$Css$Structure$appendRepeatableToLastSelector(selector), declarations);
            case 'NestSnippet':
                var _v5 = styles.a;
            ...
            case 'WithPseudoElement':
                ...
                var nestedStyles1 = _v11.b;
                var rest = styles.b;
                return A4($rtfeldman$elm_css$Css$Preprocess$Resolve$applyNestedStylesToLast, nestedStyles1, rest, $rtfeldman$elm_css$Css$Structure$appendPseudoElementToLastSelector(pseudoElement), declarations);
            case 'WithKeyframes':
                var str5 = styles.a.a;
                var rest = styles.b;
                var name = $rtfeldman$elm_css$Hash$fromString(str5);
                var newProperty = 'animation-name:' + name;
                var newDeclarations1 = A2($rtfeldman$elm_css$Css$Preprocess$Resolve$applyStyles, rest, A2($rtfeldman$elm_css$Css$Structure$appendProperty, newProperty, declarations));
                return A2($elm$core$List$append, newDeclarations1, _List_fromArray([
            ...
            case 'WithMedia':
                var _v12 = styles.a;
                var mediaQueries1 = _v12.a;
                var nestedStyles1 = _v12.b;
                var rest = styles.b;
                var extraDeclarations = function() {
                    ...
                    if (!_v13.b) return _List_Nil;
                        ...
                        return A2($elm$core$List$map, $rtfeldman$elm_css$Css$Structure$styleBlockToMediaRule(mediaQueries1), A2($rtfeldman$elm_css$Css$Preprocess$Resolve$applyStyles, nestedStyles1, $elm$core$List$singleton($rtfeldman$elm_css$Css$Structure$StyleBlockDeclaration(A3($rtfeldman$elm_css$Css$Structure$StyleBlock, firstSelector, otherSelectors, _List_Nil)))));
                    }
                }();
    ...
    var $rtfeldman$elm_css$Css$stringsToValue = function(list) {
        return $elm$core$List$isEmpty(list) ? {
            ...
            value: A2($elm$core$String$join, ', ', A2($elm$core$List$map, function(s) {
                return s;
            }, list))
        };
    };
    var $rtfeldman$elm_css$Css$fontFamilies = A2($elm$core$Basics$composeL, $rtfeldman$elm_css$Css$prop1('font-family'), $rtfeldman$elm_css$Css$stringsToValue);
    var $rtfeldman$elm_css$Css$fontSize = $rtfeldman$elm_css$Css$prop1('font-size');
    var $rtfeldman$elm_css$Css$Transitions$FontSize = {
        $: 'FontSize'
    };
    ...
    var $rtfeldman$elm_css$Css$Transitions$durationTransition = F2(function(animation, duration) {
    ...
    var $rtfeldman$elm_css$Css$overline = {
        textDecorationLine: $rtfeldman$elm_css$Css$Structure$Compatible,
        value: 'overline'
    };
    ...
    var $rtfeldman$elm_css$Css$uppercase = {
        textTransform: $rtfeldman$elm_css$Css$Structure$Compatible,
        value: 'uppercase'
    };
    var $author$project$Styled$styledAnchor = _List_fromArray([
        ...
        $rtfeldman$elm_css$Css$hover(_List_fromArray([
            $rtfeldman$elm_css$Css$fontSize($rtfeldman$elm_css$Css$rem(2.2)),
            $rtfeldman$elm_css$Css$textDecoration($rtfeldman$elm_css$Css$none)
        ])),
        $rtfeldman$elm_css$Css$Transitions$transition(_List_fromArray([
            $rtfeldman$elm_css$Css$Transitions$fontSize(300),
            A3($rtfeldman$elm_css$Css$Transitions$transform3, 1000, 1000, $rtfeldman$elm_css$Css$Transitions$easeInOut)
        ]))
    ]);
    var $author$project$Styled$anchorExternal = function(route) {
        return $rtfeldman$elm_css$Html$Styled$a(_List_fromArray([
            $rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Styled$styledAnchor),
            $rtfeldman$elm_css$Html$Styled$Attributes$href(route)
        ]));
    };
    var $author$project$Router$href = function(route) {
        return $rtfeldman$elm_css$Html$Styled$Attributes$href($author$project$Router$routeToString(route));
    };
    var $author$project$Styled$anchorInternal = function(route) {
        return $rtfeldman$elm_css$Html$Styled$a(_List_fromArray([
            $rtfeldman$elm_css$Html$Styled$Attributes$css($author$project$Styled$styledAnchor),
            $author$project$Router$href(route)
        ]));
    };
    var $author$project$Router$externalRouteToString = function(route) {
        switch(route.$){
            case 'SeznamRoute':
    ...
    var $author$project$Styled$navbarLinksWrapper = $rtfeldman$elm_css$Html$Styled$div(_List_fromArray([
    ...
    var $author$project$Styled$navbarWrapper = $rtfeldman$elm_css$Html$Styled$div(_List_fromArray([
        $rtfeldman$elm_css$Html$Styled$Attributes$css(_List_fromArray([
            $rtfeldman$elm_css$Css$displayFlex,
            $rtfeldman$elm_css$Css$justifyContent($rtfeldman$elm_css$Css$spaceBetween),
            $rtfeldman$elm_css$Css$alignItems($rtfeldman$elm_css$Css$center),
            $rtfeldman$elm_css$Css$marginBottom($rtfeldman$elm_css$Css$rem(2)),
            $rtfeldman$elm_css$Css$padding($rtfeldman$elm_css$Css$rem(1)),
            $rtfeldman$elm_css$Css$backgroundColor($author$project$Styled$theme.black),
            A4($rtfeldman$elm_css$Css$boxShadow4, $rtfeldman$elm_css$Css$rem(0), $rtfeldman$elm_css$Css$rem(0.1), $rtfeldman$elm_css$Css$rem(4), $author$project$Styled$theme.darkShadow)
        ]))
    ]));
    ...
    var $author$project$Header$ClickedShowLanguageButtons = function(a) {
        return {
            $: 'ClickedShowLanguageButtons',
            a: a
        };
    };
    ...
    var $author$project$Styled$colorTransition = $rtfeldman$elm_css$Css$Transitions$transition(_List_fromArray([
        $rtfeldman$elm_css$Css$Transitions$backgroundColor(300),
        A3($rtfeldman$elm_css$Css$Transitions$transform3, 120, 1000, $rtfeldman$elm_css$Css$Transitions$easeInOut)
    ]));
    var $author$project$Styled$fontTransition = $rtfeldman$elm_css$Css$Transitions$transition(_List_fromArray([
        $rtfeldman$elm_css$Css$Transitions$fontSize(300),
        A3($rtfeldman$elm_css$Css$Transitions$transform3, 120, 1000, $rtfeldman$elm_css$Css$Transitions$easeInOut)
    ]));
    ...
    var $author$project$Styled$btn = F2(function(variant, msg) {
            ...
            switch(variant.$){
                ...
                default:
                    return _List_fromArray([
                        $rtfeldman$elm_css$Css$backgroundColor($author$project$Styled$theme.black),
                        $rtfeldman$elm_css$Css$hover(_List_fromArray([
                            $rtfeldman$elm_css$Css$fontSize($rtfeldman$elm_css$Css$rem(2.5))
                        ])),
                        $author$project$Styled$fontTransition
                    ]);
            }
        ...
        return $rtfeldman$elm_css$Html$Styled$button(_List_fromArray([
            $rtfeldman$elm_css$Html$Styled$Attributes$css(_Utils_ap(styles, variantStyles)),
    ...
    var $ChristophP$elm_i18next$I18Next$t = F2(function(_v0, key) {
        var translations = _v0.a;
        return A2($elm$core$Maybe$withDefault, key, A2($elm$core$Dict$get, key, translations));
    });
    ...
    var $ChristophP$elm_i18next$I18Next$replacePlaceholders = F3(function(replacements, delims, str) {
        var _v0 = $ChristophP$elm_i18next$I18Next$delimsToTuple(delims);
        var start = _v0.a;
        var end = _v0.b;
        return A3($elm$core$List$foldl, F2(function(_v1, acc) {
            var key = _v1.a;
            var value = _v1.b;
            return A3($elm$core$String$replace, _Utils_ap(start, _Utils_ap(key, end)), value, acc);
        }), str, replacements);
    });
    var $ChristophP$elm_i18next$I18Next$tr = F4(function(_v0, delims, key, replacements) {
        var translations = _v0.a;
    ...
    var $author$project$Translations$translationsForLanguage = function(_v0) {
        var allTranslations = _v0.allTranslations;
        var selectedLanguage = _v0.selectedLanguage;
        if (selectedLanguage.$ === 'En') return allTranslations.en;
        else return allTranslations.ru;
    };
    var $author$project$Translations$translators = function(_v0) {
        var modelPayload = _v0.a;
        var translations = $author$project$Translations$translationsForLanguage(modelPayload);
        return {
            t: $ChristophP$elm_i18next$I18Next$t(translations),
            tr: A2($ChristophP$elm_i18next$I18Next$tr, translations, $ChristophP$elm_i18next$I18Next$Curly)
        };
    };
    ...
    var $author$project$Header$view = function(sharedState) {
        ...
        return $author$project$Styled$navbarWrapper(_List_fromArray([
            $author$project$Styled$navbarLinksWrapper(_List_fromArray([
                A2($author$project$Styled$anchorInternal, $author$project$Router$NextPageRoute, _List_fromArray([
                    $rtfeldman$elm_css$Html$Styled$text(t('buttons.nextPage'))
                ])),
                A2($author$project$Styled$anchorInternal, $author$project$Router$ToDoItemRoute, _List_fromArray([
                    $rtfeldman$elm_css$Html$Styled$text(t('buttons.home'))
                ])),
                A2($author$project$Styled$anchorExternal, $author$project$Router$externalRouteToString($author$project$Router$GoogleRoute), _List_fromArray([
    ...
    var $author$project$Pages$ToDoItemPage$buttonTitle = F2(function(_v0, sharedState) {
        var showingItems = _v0.showingItems;
    ...
    var $author$project$Styled$itemsWrapper = $rtfeldman$elm_css$Html$Styled$div(_List_fromArray([
        $rtfeldman$elm_css$Html$Styled$Attributes$css(_List_fromArray([
            ...
            $rtfeldman$elm_css$Css$backgroundColor($author$project$Styled$theme.itemsWrapperColor),
            $rtfeldman$elm_css$Css$width($rtfeldman$elm_css$Css$pct(60)),
            $rtfeldman$elm_css$Css$borderRadius($rtfeldman$elm_css$Css$rem(2)),
            $rtfeldman$elm_css$Css$padding($rtfeldman$elm_css$Css$rem(2)),
    ...
    var $rtfeldman$elm_css$Html$Styled$Events$targetChecked = A2($elm$json$Json$Decode$at, _List_fromArray([
        'target',
        'checked'
    ]), $elm$json$Json$Decode$bool);
    var $rtfeldman$elm_css$Html$Styled$Events$onCheck = function(tagger) {
        return A2($rtfeldman$elm_css$Html$Styled$Events$on, 'change', A2($elm$json$Json$Decode$map, tagger, $rtfeldman$elm_css$Html$Styled$Events$targetChecked));
    };
    var $rtfeldman$elm_css$Html$Styled$Attributes$type_ = $rtfeldman$elm_css$Html$Styled$Attributes$stringProperty('type');
    var $author$project$Styled$checkbox = F2(function(bool, msg) {
        return $rtfeldman$elm_css$Html$Styled$input(_List_fromArray([
            $rtfeldman$elm_css$Html$Styled$Attributes$type_('checkbox'),
            $rtfeldman$elm_css$Html$Styled$Attributes$checked(bool),
            $rtfeldman$elm_css$Html$Styled$Events$onCheck(msg),
            $rtfeldman$elm_css$Html$Styled$Attributes$css(_List_fromArray([
                $rtfeldman$elm_css$Css$cursor($rtfeldman$elm_css$Css$pointer)
            ]))
        ]));
    });
    var $author$project$ToDoItems$filterItems = function(textInput) {
        return $elm$core$List$filter(function(item) {
            return A2($elm$core$String$contains, $elm$core$String$toLower(textInput), $elm$core$String$toLower(item.title));
        });
    };
    ...
    var $author$project$Styled$textDiv = $rtfeldman$elm_css$Html$Styled$div(_List_fromArray([
        $rtfeldman$elm_css$Html$Styled$Attributes$css(_List_fromArray([
            $rtfeldman$elm_css$Css$marginLeft($rtfeldman$elm_css$Css$rem(2)),
            $rtfeldman$elm_css$Css$fontFamilies(_List_fromArray([
                'Courier New'
            ])),
    ...
    var $author$project$Pages$ToDoItemPage$viewToDos = F2(function(model, sharedState) {
        ...
        return A2($rtfeldman$elm_css$Html$Styled$div, _List_Nil, _List_fromArray([
            function() {
                var _v1 = model.toDoItemsWebData;
                switch(_v1.$){
                    case 'NotAsked':
                        return $author$project$Styled$styledText(_List_fromArray([
                            $rtfeldman$elm_css$Html$Styled$text('')
                        ]));
                    case 'Loading':
                        return $author$project$Styled$styledText(_List_fromArray([
                            $rtfeldman$elm_css$Html$Styled$text(t('text.loading'))
                        ]));
                    case 'Failure':
                        return $author$project$Styled$styledText(_List_fromArray([
                            $rtfeldman$elm_css$Html$Styled$text(t('text.loadingFailed'))
                        ]));
                    default:
    ...
    var $author$project$Main$pageView = F2(function(page, _v0) {
        var sharedState = _v0.sharedState;
        switch(page.$){
            case 'ToDoItemPage':
                var pageModel = page.a;
                return A2($rtfeldman$elm_css$Html$Styled$map, $author$project$Main$ToDoItemPageMsg, A2($author$project$Pages$ToDoItemPage$view, pageModel, sharedState));
            case 'NextPage':
                var pageModel = page.a;
    ...
    var $author$project$Styled$styledh2 = $rtfeldman$elm_css$Html$Styled$h2(_List_fromArray([
        $rtfeldman$elm_css$Html$Styled$Attributes$css(_List_fromArray([
            $rtfeldman$elm_css$Css$fontFamilies(_List_fromArray([
                'Courier New'
            ])),
            $rtfeldman$elm_css$Css$textTransform($rtfeldman$elm_css$Css$uppercase),
            $rtfeldman$elm_css$Css$fontSize($rtfeldman$elm_css$Css$rem(2)),
            $rtfeldman$elm_css$Css$letterSpacing($rtfeldman$elm_css$Css$rem(2))
        ]))
    ]));
    ...
    var $rtfeldman$elm_css$VirtualDom$Styled$toStyleNode = function(styles) {
        return A3($elm$virtual_dom$VirtualDom$node, 'span', _List_Nil, _List_fromArray([
            A3($elm$virtual_dom$VirtualDom$node, 'style', _List_Nil, $elm$core$List$singleton($elm$virtual_dom$VirtualDom$text($rtfeldman$elm_css$VirtualDom$Styled$toDeclaration(styles))))
        ]));
    };
    ...
    var $author$project$Main$view = function(model) {
        if (model.$ === 'Ready') {
            ...
            switch(page.$){
                case 'ToDoItemPage':
                    return {
                        body: _List_fromArray([
                            $rtfeldman$elm_css$Html$Styled$toUnstyled(A2($rtfeldman$elm_css$Html$Styled$div, _List_Nil, _List_fromArray([
                                $author$project$Main$headerView(readyModel),
                ...
                case 'NextPage':
                    var _v2 = $author$project$Translations$translators($author$project$Taco$getTranslations(readyModel.sharedState));
                    var t = _v2.t;
                    return {
                        body: _List_fromArray([
                            $rtfeldman$elm_css$Html$Styled$toUnstyled(A2($rtfeldman$elm_css$Html$Styled$div, _List_Nil, _List_fromArray([
            ...
            body: _List_fromArray([
                $rtfeldman$elm_css$Html$Styled$toUnstyled($rtfeldman$elm_css$Html$Styled$text('Something went wrong - flags error...'))
            ]),
            title: 'Flags Error'
        };
    };
                ...
                "types": {
                    ...
                    "unions": {
                        ...
                        "Pages.ToDoItemPage.Msg": {
                            ...
                            "tags": {
                                "FetchResponse": [
                                    "RemoteData.WebData (List.List ToDoItems.ToDoItem)"
                                ],
                                "ToggledToDoList": [],
                                "ClickedCompleteToDoItem": [
                                    "Basics.Int",
...
},{}],"1YbVS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
